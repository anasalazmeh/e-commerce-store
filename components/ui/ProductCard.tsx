...
import useCart from "@/hooks/use-preview-cart";
...
const ProductCard = ({ data }: { data: Product }) => {
  ...
  const onPreview:MouseEventHandler<HTMLButtonElement>=(even)=>{
    even.stopPropagation();
    previewModal.onOpen(data)
  }
  const onAddToCart:MouseEventHandler<HTMLButtonElement>=(even)=>{
    even.stopPropagation();
    cart.addItem(data)
  }
  return (
